...
$queryProduct = "SELECT id,name,price,quantity FROM products where id='$id';  ";
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-12 col-sm-6">
                ...
                WHERE p.id='$id';
                ";
                $resFirstImg = mysqli_query($con, $queryImages);
                $rowFirstImg = mysqli_fetch_assoc($resFirstImg);
                ?>
                <div class="col-12">
                    <img src="<?php echo $rowFirstImg['web_path'] ?>" class="product-image">
                </div>
            ...
            <div class="col-12 col-sm-6">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus sequi soluta in laborum! Fugit vero placeat quia sapiente iure cum, mollitia eligendi qui ipsam, quasi deleniti odit aut reprehenderit laudantium?</p>
                <hr>
                <h4>Quantity: <?php echo $rowProduct['quantity'] ?></h4>
